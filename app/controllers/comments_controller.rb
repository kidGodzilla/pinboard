class CommentsController < ApplicationController
  ...
  def edit
    if @comment.user != current_user
      respond_to do |format|
        format.html { redirect_to idea_path, alert: 'You are not authorized to edit this comment.' }
  ...
  def destroy
    ...
    if @comment.user != current_user
      respond_to do |format|
        format.html { redirect_to @idea, alert: 'You are not authorized to destroy this comment.' }
        format.json { head :no_content }
      end
      return false
    end
